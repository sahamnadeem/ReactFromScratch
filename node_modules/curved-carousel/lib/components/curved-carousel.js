...
var CurvedCarousel = (function (_React$Component) {
  ...
  _createClass(CurvedCarousel, [{
    ...
    value: function _setPosition() {
      this.setState({
        containerWidth: _reactAddons2['default'].findDOMNode(this.refs.container).offsetWidth
      });
    }
  }, {
    key: '_onSelect',
    ...
    value: function _childrenWithPositions() {
      ...
      Array.prototype.slice.call(this.props.children, 0, this.props.children.length).reverse().forEach(function (child, index) {
        children.unshift((0, _reactLibCloneWithProps2['default'])(child, { key: 'clone' + (children.length - index) }));
      });
      Array.prototype.slice.call(this.props.children, 0, this.props.children.length).forEach(function (child, index) {
        children.push((0, _reactLibCloneWithProps2['default'])(child, { key: 'clone' + index }));
      });
      children.forEach(function (child, index) {
        ...
        returnChildren.push((0, _reactLibCloneWithProps2['default'])(child, { style: style, key: index, onClick: _this._onSelect.bind(_this, index) }));
      });
...
CurvedCarousel.propTypes = {
  childWidth: _reactAddons2['default'].PropTypes.number,
  curve: _reactAddons2['default'].PropTypes.number,
  spacing: _reactAddons2['default'].PropTypes.number,
  rotation: _reactAddons2['default'].PropTypes.bool,
  friction: _reactAddons2['default'].PropTypes.number
};
